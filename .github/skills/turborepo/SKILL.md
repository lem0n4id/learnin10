---
name: turborepo
description: "Turborepo monorepo build system guidance for task pipelines, caching, filtering, CI optimization, and monorepo structure."
metadata:
  version: 2.8.3-canary.9
---

Triggers on: turbo.json, task pipelines, dependsOn, caching, remote cache, the "turbo" CLI, --filter, --affected, CI optimization, environment variables, internal packages, monorepo structure/best practices, and boundaries.
